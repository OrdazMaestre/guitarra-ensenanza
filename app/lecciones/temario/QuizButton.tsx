    ...
    <>
      ...
      <style>{`
        ...
        /* luz.png en si misma esta dibujada perfectamente horizontal (la punta y el eje del
           ...
           cristal -- se calculo por PCA (autovectores de la matriz de covarianza) de los pixeles
           del cristal, dando un eje de unos -28deg respecto a la horizontal (contrastado tambien
           contra el vector centroide-del-foco -> centro-del-cristal, que daba una cifra muy
           parecida). La primera estimacion (-17deg, a partir de la silueta del cuerpo del
           cilindro) se quedaba corta -- se corrigio a ojo comparando capturas hasta que el haz
           siguiera visualmente la misma linea que el cristal. Sin esta rotacion la luz sale
