...
export const enunciadosEstaticas: EnunciadosEstaticas = {
  '1.1': () => '¿Dónde están los trastes?',
  '1.3': () => '¿Dónde colocamos los dedos de la mano derecha?',
  '1.4': () => '¿Dónde colocamos los dedos de la mano izquierda?',
  '1.5': () => '¿Con qué parte de la guitarra hacemos sonido?',
  '1.1.1': () => 'Un sonido agudo vibra ___ que uno grave',
  '1.1.2': () => '¿Dónde tenemos el primer armónico (1 octava)?',
  '2.2': () => '¿Cuántas notas naturales hay?',
  '2.2.1': () => '¿Cuál es la afinación estándar?',
  '2.3': () => '¿Cuál es el traste cero?',
  '2.4': () => '¿Qué trastes tienen las mismas notas?',
  '2.5': () => '¿Qué cuerdas tienen las mismas notas?',
  '3.1': () => '¿Qué significa el 0 en una tablatura?',
  '5.1': () => '¿Qué grupo compuso la canción Let It Be?',
  '6.1': () => '¿Qué notas usa el acorde de Sol Mayor?',
  '6.2': () => '¿Cuántas figuras tiene por lo general un acorde?',
  '7.1': () => '¿Qué es un arpegio?',
  '7.2': () => '¿Qué acordes puedo arpegiar?',
  '8.1': () => '¿Cuántas notas tiene la pentatónica?',
  '8.1.1': () => '¿Cuál es la blue note de Sol mayor?',
  '8.1.2': () => '¿Cuál es la blue note de Mi menor?',
  '8.1.4': () => '¿Qué diferencia hay entre música clásica y música moderna?',
  '8.1.6': () => '¿Qué estilos son parte de la música clásica?',
  '8.2': () => '¿Cuántas notas tiene la pentatónica de blues?',
  '8.3': () => '¿Qué otra pentatónica tenemos con las notas de la pentatónica de Sol?',
  '8.4': () => '¿Qué combinación de notas usa la pentatónica de Sol mayor y Mi menor?',
  '9.1.1': () => 'Sol Mayor es...',
  '9.3.1': () => '¿Qué nota es F# en Sol Mayor?',
  '9.3.3': () => '¿Cuántos acordes tiene la escala de Sol Mayor?',
  '9.3.4': () => '¿Qué diferencia hay entre tríada y cuatríada?',
  '9.4': () => '¿Qué patrón de semitonos tiene la escala mayor?',
  '9.5': () => '¿Qué patrón de semitonos tiene la escala menor?',
  '9.6': () => '¿Cómo se llama a la escala menor que tiene las mismas notas que una escala mayor?',
  '9.7': () => '¿# es...?',
  '9.8': () => '¿Bemol es...?',
  '9.9': () => '¿Qué nota es la octava?',
};
...
export const enunciadosArithmetic: EnunciadosArithmetic = {
  '1.2': (fretX, fretY) => `Distancia en SEMITONOS entre los trastes ${fretX} y ${fretY}.`,
  '1.6': (fretX, fretY) => `¿Distancia en TONOS entre los trastes ${fretX} y ${fretY}?`,
  '9.1': () => '¿Qué distancia hay entre estas dos notas?',
  '9.2': (tonos) => `¿Cuántos semitonos tiene ${tonos} tono${tonos === 1 ? '' : 's'}?`,
  '9.3': (semitonos) => `¿Cuántos tonos son ${semitonos} semitonos?`,
};
...
export const enunciadosNotation: EnunciadosNotation = {
  '2.1': (notaMostrada) => `¿Qué otro nombre tiene "${notaMostrada}"?`,
  '9.11': (nota) => `${nota}# va ANTES de...`,
  '9.11.1': (nota) => `${nota}b va DESPUÉS de...`,
};
...
export const enunciadosTheory: EnunciadosTheory = {
  '3.2': () => '¿Esta cuerda es aguda, media o grave?',
  '6.3': () => '¿Cuál es esta nota?',
  '8.1.3': (tonica, modo) => `¿Cuál es la BLUE NOTE de la pentatónica de ${tonica} ${modo}?`,
  '8.1.5': (generoLabel) => `¿En qué siglo comienza ${generoLabel} según la web?`,
  '9.1.2': () => '¿Qué representa este dibujo?',
  '9.10': () => '¿Qué nota NO está en las cuerdas al aire en Mi estándar?',
};
...
export const enunciadosChordBank: EnunciadosChordBank = {
  ...
  '6.4': () => '¿Qué tablatura corresponde a este acorde?',
...
export const enunciadosDegree: EnunciadosDegree = {
  '9.3.2': (escalaLabel) => `¿Qué nota es esta en la escala de ${escalaLabel}?`,
  ...
  '9.3.5': (grado, escalaLabel) => `¿Cuál es el acorde ${grado} de ${escalaLabel}?`,
  '9.3.6': (escalaLabel) => `Este acorde pertenece a la escala de ${escalaLabel}. ¿Qué número tiene?`,
  ...
  '9.3.7': (nombreSeptima) => `¿Qué notas tiene ${nombreSeptima}?`,
};
